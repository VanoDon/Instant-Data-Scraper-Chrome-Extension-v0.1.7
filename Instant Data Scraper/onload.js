...
chrome.extension.onRequest.addListener(function(a, b, c) {
    return console.log("Got request", a), "nextTable" == a.action || "findTables" == a.action ? ("findTables" == a.action ? e() : n = (n + 1) % m.length, f(), c({
        tableId: n,
        tableSelector: m[n].selector,
        href: window.location.href,
        hostname: window.location.hostname
    })) : "getTableData" == a.action ? h(c, a.selector) : "getNextButton" == a.action ? j(c) : "clickNext" == a.action ? l(a.selector, c) : "markNextButton" == a.action ? l(a.selector, c, !0) : void c({})
